...
public class CommandContext {
    ...
    public CommandContext(NekoffeeClient client, ConfigManager config, DatabaseManager dbManager, MessageCreateEvent event, String commandName, List<String> args) {
        this.client = client;
        this.config = config;
